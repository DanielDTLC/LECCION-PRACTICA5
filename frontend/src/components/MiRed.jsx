// src/components/MiRed.jsx
// Red multinivel visual:
...
// Nota: la prop se llama "nodo" porque "ref" es una prop reservada en React
  ...
  return (
    <div>
      ...
      <p className="text-slate-500 mb-6">
        ...
        {TASA_COMISION[2] * 100} % de nivel 2 y {TASA_COMISION[3] * 100} % de
        nivel 3.
      </p>
