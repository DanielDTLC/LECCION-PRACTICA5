...
// Resumen general con KPIs calculados desde el estado real:
// - Funciones puras de data/red.js en lugar de valores estáticos
import {
  redInicial,
  contarRed,
  sumarVentasRed,
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-slate-100">
          ...
          <p className="text-center text-sm text-slate-500 mt-2 font-semibold">
            Nivel actual: {nivel} ({referidosDirectos} / 6 directos para
            Diamante)
          </p>
        </div>
      </div>
